...
export default {
  ...
  methods: {
    ...
    async onsubmit(){
        ...
        const mutation = this.hasId?"updateReceta":"createReceta"
        ...
        //         }
        //     },
        //     mutation:require('../../graphql/createReceta.gql'),
        ...
        .mutate({
         ...
         mutation: require("../../graphql/" + mutation + ".gql"),
          //mutation:require('../../graphql/createReceta.gql'),
          variables: this.recipe,
          update: (cache, myreceta) => {
            if (mutation == "createReceta") {
              const data = cache.readQuery({
                query: require("../../graphql/userRecipes.gql"),
                variables: { id },
              });
              data.recipes.data.push(myreceta.data[mutation].data);
              cache.writeQuery({
                query: require("../../graphql/userRecipes.gql"),
                variables: { id },
                data,
         ...
         .then(data => {
             ...
             this.$store.dispatch("snackbars/setSnack",{text:"Receta Guardada", color:'info'})
         })
        .catch(e => {
            console.log(e)
